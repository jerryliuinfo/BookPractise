package com.apache.book.framewok.aroute.bean;
...
import com.apache.book.framewok.aroute.facade.service.SerializationService;
...
public class Postcard extends RouteMeta {
    ...
    public Object navigation(Context context, NavigationCallback callback) {
        return ARouter.getInstance().navigation(context,  -1, this,callback);
    }
    ...
    public void navigation(Activity mContext, int requestCode, NavigationCallback callback) {
        ARouter.getInstance().navigation(mContext,  requestCode,this, callback);
    }
